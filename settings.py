...
class Active_Pattern(object):
    ...
    def pattern(group, condition, day):
        pttn = [
            [{
                'before_SoE': [[[1, 0, 0]] * 24, [[1, 0, 0]] * 24],
                '1week_SoE': [[[1, 0, 0]] * 24, [[1, 0, 0]] * 24],
                '2week_SoE': [[[1, 0, 0]] * 24, [[1, 0, 0]] * 24],
                '3week_SoE': [[[1, 0, 0]] * 24, [[1, 0, 0]] * 24],
                '4week_SoE': [[[1, 0, 0]] * 24, [[1, 0, 0]] * 24],
                '5__week_SoE': [[[1, 0, 0]] * 24, [[1, 0, 0]] * 24],
                'after_SoE': [[[1, 0, 0]] * 24, [[1, 0, 0]] * 24],
            }, {
                'before_SoE': [[[1, 0, 0]] * 24, [[1, 0, 0]] * 24],
                '1week_SoE': [[[1, 0, 0]] * 24, [[1, 0, 0]] * 24],
                '2week_SoE': [[[1, 0, 0]] * 24, [[1, 0, 0]] * 24],
